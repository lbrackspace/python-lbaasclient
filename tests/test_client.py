...
import lbaasclient.client
import lbaasclient.extension
import lbaasclient.tests.fakes as fakes
import lbaasclient.v1_1.client
import lbaasclient.v3.client
...
class ClientTest(utils.TestCase):
    ...
    def test_client_with_timeout(self):
        instance = lbaasclient.client.HTTPClient(user='user',
                                                password='password',
                                                projectid='project',
                                                timeout=2,
    ...
    def test_client_reauth(self):
        ...
        mock_request = mock.Mock()
        mock_request.side_effect = lbaasclient.exceptions.Unauthorized(401)
        with mock.patch('requests.Session.request', mock_request):
            try:
    ...
    def test_get_client_class_v3(self):
        output = lbaasclient.client.get_client_class('3')
        self.assertEqual(output, lbaasclient.v3.client.Client)

    def test_get_client_class_v2(self):
        output = lbaasclient.client.get_client_class('2')
        self.assertEqual(output, lbaasclient.v1_1.client.Client)
    ...
    def test_get_client_class_v1_1(self):
        output = lbaasclient.client.get_client_class('1.1')
        self.assertEqual(output, lbaasclient.v1_1.client.Client)

    def test_get_client_class_unknown(self):
        self.assertRaises(lbaasclient.exceptions.UnsupportedVersion,
                          lbaasclient.client.get_client_class, '0')

    def test_client_with_os_cache_enabled(self):
        cs = lbaasclient.v1_1.client.Client("user", "password", "project_id",
    ...
    def test_client_set_management_url_v3(self):
        cs = lbaasclient.v3.client.Client("user", "password", "project_id",
                                         auth_url="foo/v2")
        cs.set_management_url("blabla")
        self.assertEqual("blabla", cs.client.management_url)
    ...
    def test_clent_extensions_v3(self):
        ...
        extensions = [
            lbaasclient.extension.Extension(fake_attribute_name1,
                                fakes),
            lbaasclient.extension.Extension(fake_attribute_name2,
                                utils),
        ]
    ...
    @mock.patch.object(lbaasclient.client.HTTPClient, 'authenticate')
