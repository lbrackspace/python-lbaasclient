...
class ShellTest(utils.TestCase):
    ...
    def setUp(self):
        ...
        self.useFixture(fixtures.MonkeyPatch(
                        'lbaasclient.client.get_client_class',
                        mock.MagicMock))
        self.nc_util = mock.patch('lbaasclient.utils.isunauthenticated').start()
    ...
    def shell(self, argstr, exitcodes=(0,)):
        ...
        try:
            ...
            _shell = lbaasclient.shell.OpenStackComputeShell()
